	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
			...
			.authorizeHttpRequests(authorize -> authorize
					...
					.requestMatchers("/api/doctor/update-info").hasAnyAuthority(Role.DOCTOR.toString())
					.requestMatchers("/api/doctor/edit-status/*").permitAll()
					
					.requestMatchers("/api/doctor/get-all-listing")
					.hasAnyAuthority(Role.PATIENT.toString(),Role.DOCTOR.toString(),Role.NURSE.toString())
					.requestMatchers("/api/doctor/get-by-id/*")
					.hasAnyAuthority(Role.PATIENT.toString(),Role.DOCTOR.toString(),Role.NURSE.toString())
					.requestMatchers("/api/doctor/get-by-name-listing")
					.hasAnyAuthority(Role.PATIENT.toString(),Role.DOCTOR.toString(),Role.NURSE.toString())
					.requestMatchers("/api/doctor/get-by-speclization-listing")
					.hasAnyAuthority(Role.PATIENT.toString(),Role.DOCTOR.toString(),Role.NURSE.toString())
					...
					.requestMatchers("/api/admin/update").hasAuthority(Role.ADMIN.toString())
					.requestMatchers("/api/admin/get").hasAuthority(Role.ADMIN.toString())
					...
					//prescription api
					.requestMatchers("/api/prescription/add/*")
					.hasAnyAuthority(Role.DOCTOR.toString(),Role.NURSE.toString(),Role.ADMIN.toString())
